...
class BrowserNavigationTester {
  ...
  setupMocks() {
    global.history = this.history as any;
    global.location = this.location as any;
  }
...
async function runBrowserNavigationTests() {
  ...
  console.log(`   Filter Persistence: ${results.navigationValidation.filterPersistence ? '✅' : '❌'}`);
  console.log(`   Sort Persistence: ${results.navigationValidation.sortPersistence ? '✅' : '❌'}`);
  console.log(`   View Mode Persistence: ${results.navigationValidation.viewModePersistence ? '✅' : '❌'}`);
  console.log(`   Search Persistence: ${results.navigationValidation.searchPersistence ? '✅' : '❌'}`);
  console.log(`   Modal Deep Linking: ${results.navigationValidation.modalDeepLinking ? '✅' : '❌'}`);
