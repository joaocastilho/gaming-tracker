<script lang="ts">
	...
	// Function to get filtered planned games
	function getFilteredPlannedGames(): Game[] {
		...
		// Apply tab-specific filtering (planned games only)
	...
	// Derived for filtered planned games
	let plannedGames = $derived(getFilteredPlannedGames());
</script>
